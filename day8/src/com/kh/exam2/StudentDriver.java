...
public class StudentDriver {
    public static void main(String[] args) {
        ...
        // 첫 번째 학생의 총점을 계산한다
        int total1 = stud1.getTotal();

        // 첫 번째 학생의 학점을 부여한다
        char grade1 = stud1.getGrade();

        // 첫 번째 학생의 이름, 총점과 학점을 출력한다
        System.out.println(stud1.getName() + "의 총점은 " + total1 + "점이고 학점은 " + grade1 + "이다.");

        // 두 번째 학생의 퀴즈 점수, 중간시험 점수와 기말시험 점수를 읽어 들인다
        stud2.inputGrades();

        // 두 번째 학생의 총점을 계산한다
        int total2 = stud2.getTotal();

        // 두 번째 학생의 학점을 부여한다
        char grade2 = stud2.getGrade();

        // 두 번째 학생의 이름, 총점과 학점을 출력한다
        System.out.println(stud2.getName() + "의 총점은 " + total2 + "점이고 학점은 " + grade2 + "이다.");
        System.out.println();
