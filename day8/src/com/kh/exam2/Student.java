...
//        this.quizscore = Integer.parseInt(scan.nextLine());
        ...
        while (score < 0 || score > 100) {
            System.out.println("점수는 0이상 100이하의 숫자여야 합니다.");
            System.out.print(this.getName() + "학생의 퀴즈 점수 입력: ");
        ...
        System.out.print(this.getName() + "학생의 중간 점수 입력: ");
        score = Integer.parseInt(scan.nextLine());
        while (score < 0 || score > 100) {
            System.out.println("점수는 0이상 100이하의 숫자여야 합니다.");
            System.out.print(this.getName() + "학생의 중간 점수 입력: ");
        ...
        System.out.print(this.getName() + "학생의 기말 점수 입력: ");
        score = Integer.parseInt(scan.nextLine());
        while (score < 0 || score > 100) {
            System.out.println("점수는 0이상 100이하의 숫자여야 합니다.");
            System.out.print(this.getName() + "학생의 기말 점수 입력: ");
        ...
        System.out.println(name + "의 어떤 시험 점수를 보시겠습니까? (1: 퀴즈, 2: 중간 3. 기말)");
        int scoreNum = Integer.parseInt(scan.nextLine());
        switch (scoreNum) {
            case 1:
                System.out.println(name + "의 퀴즈 점수를 입력하라.");
//                int quizscore = Integer.parseInt(scan.nextLine());
                this.setQuizScore(Integer.parseInt(scan.nextLine()));
                System.out.println(name + "의 퀴즈 점수는 " + getQuizScore() + "점입니다.");
                break;
            case 2:
                System.out.println(name + "의 중간시험 점수를 입력하라.");
                int midtermscore = Integer.parseInt(scan.nextLine());
                System.out.println(name + "의 중간시험 점수는 " + getMidtermScore() + "점입니다.");
                break;
            case 3:
                System.out.println(name + "의 기말시험 점수를 입력하라.");
                int finalscore = Integer.parseInt(scan.nextLine());
                System.out.println(name + "의 기말시험 점수는 " + getFinalScore() + "점입니다.");
                break;
            default:
                System.out.println("1~3의 번호 중 선택해주세요.");
                break;
        }
        */
    ...
    public int getTotal() {
        int sum = quizscore + midtermscore + finalscore;
        return sum;
    }
