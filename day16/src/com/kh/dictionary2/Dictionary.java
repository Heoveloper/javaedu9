...
public class Dictionary extends TreeMap<String, String> {
    ...
    private static final int WORD_CAPACITY = 5;    //단어 최대 저장 개수
...
//                    dic.subMap(word, true, String.valueOf(nextLetter), false);
//            map = subMap;
        }
        return map;
    }
    ...
    public void del(String word) {
        ...
        System.out.println("단어의 뜻을 삭제하였습니다.");
    }
    ...
    public List<String> index(String letter) {
        ...
        NavigableMap<String, String> subMap = dic.subMap(letter, true, nextLetter + "", false);
...
//        return new ArrayList<>(subMap.keySet());
    ...
    /**
     * 통계
     * @return 1.저장된 단어의 개수 2.단어의 글자 수가 가장 많은 단어
     */
    public String showWordStatics() {
        String info = "";

        info += "1.저장된 단어 개수: " + dic.size() + "\n";
        info += "2.단어의 글자 수가 가장 많은 단어: " + getMostCharactorCount() + "\n";
        info += "3.단어 글자 수 내림차순 출력(단어만): " + descendingByLengthOfWord() + "\n";

        return info;
    }

    //단어 글자 수 내림차순 출력 (이름 있는 비교연산자)
    ...
    //단어 글자 수 내림차순 출력 (익명 비교연산자)
    private String descendingByLengthOfWord2() {
        String str = "";
